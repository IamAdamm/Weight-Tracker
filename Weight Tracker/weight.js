...
function setGoal(){
    ...
    let goalinputValue = parseFloat(goalinput.value)

    // Check if the input is a number and less than 200 but more than 40
    if(typeof startinginputValue === 'number' && startinginputValue < 200 && startinginputValue > 40){
    ...
    if(typeof goalinputValue === 'number' && goalinputValue < 200 && goalinputValue > 40){
